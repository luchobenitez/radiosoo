 ...
 */
/*
config.time.minute            = 1000 * 60;
config.time.hour              = (config.time.minute * 60);
config.time.day               = (config.time.hour * 24);
config.time.week              = (config.time.day * 7);
*/

// Session
config.session                 = {};
config.session.key             = process.env.SESSION_KEY || 'RSNGsid';
config.session.secret          = process.env.SESSION_SECRET || 'hash.radiosoo.net';
...
config.session.cookie.maxAge   = process.env.SESSION_MAX_AGE || 36000000;

// maxAge ticks * segundos * minutos * horas * dias
// cookie: {
//  domain: '*.radiosoo.net',
...
// Last FM
config.lastfm                  = {};
config.lastfm.apiKey          = process.env.LASTFM_KEY    || 'Your Key';
...
config.paypal.clientId        = process.env.PAYPAL_KEY        || 'Your Key';
config.paypal.clientSecret    = process.env.PAYPAL_SECRET     || 'Your Secret';
