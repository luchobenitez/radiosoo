                  ...
                  CommentDB.count().then(function (count) {
                    if (count === 0) {   // la tabla se inicializa solo si está vacía
                      CommentDB.bulkCreate(
                        [
                          { texto: 'Largo comentario de Comentario al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario1 al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario2 al post 0', status: 'A', TopicId: 2, UserId: 2 },
                          { texto: 'Largo comentario de Comentario3 al post 0', status: 'A', TopicId: 1, UserId: 2 },
                          { texto: 'Largo comentario de Comentario4 al post 0', status: 'A', TopicId: 2, UserId: 1 },
                          { texto: 'Largo comentario de Comentario5 al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario6 al post 0', status: 'A', TopicId: 2, UserId: 2 },
                          { texto: 'Largo comentario de Comentario7 al post 0', status: 'A', TopicId: 1, UserId: 2 },
                          { texto: 'Largo comentario de Comentario8 al post 0', status: 'A', TopicId: 2, UserId: 1 },
                          { texto: 'Largo comentario de Comentario9 al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario10 al post 0', status: 'A', TopicId: 2, UserId: 2 },
                          { texto: 'Largo comentario de Comentario11 al post 0', status: 'A', TopicId: 1, UserId: 2 },
                          { texto: 'Largo comentario de Comentario12 al post 0', status: 'A', TopicId: 2, UserId: 1 },
                          { texto: 'Largo comentario de Comentario3 al post 0', status: 'A', TopicId: 1, UserId: 2 },
                          { texto: 'Largo comentario de Comentario4 al post 0', status: 'A', TopicId: 2, UserId: 1 },
                          { texto: 'Largo comentario de Comentario5 al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario6 al post 0', status: 'A', TopicId: 2, UserId: 2 },
                          ...
                          { texto: 'Largo comentario de Comentario8 al post 0', status: 'A', TopicId: 2, UserId: 1 },
                          { texto: 'Largo comentario de Comentario9 al post 0', status: 'A', TopicId: 1, UserId: 1 },
                          { texto: 'Largo comentario de Comentario al post 0', status: 'A', TopicId: 3, UserId: 1 },
                          { texto: 'Largo comentario de Comentario1 al post 0', status: 'A', TopicId: 3, UserId: 1 },
                          { texto: 'Largo comentario de Comentario2 al post 0', status: 'A', TopicId: 4, UserId: 2 },
                          { texto: 'Largo comentario de Comentario3 al post 0', status: 'A', TopicId: 3, UserId: 2 },
                          { texto: 'Largo comentario de Comentario4 al post 0', status: 'A', TopicId: 4, UserId: 1 },
                          { texto: 'Largo comentario de Comentario5 al post 0', status: 'A', TopicId: 3, UserId: 1 },
                          { texto: 'Largo comentario de Comentario6 al post 0', status: 'A', TopicId: 4, UserId: 2 },
                          { texto: 'Largo comentario de Comentario7 al post 0', status: 'A', TopicId: 3, UserId: 2 },
                          { texto: 'Largo comentario de Comentario8 al post 0', status: 'A', TopicId: 4, UserId: 1 },
                          { texto: 'Largo comentario de Comentario9 al post 0', status: 'A', TopicId: 3, UserId: 1 }
                        ]
                      ).then(function () {
